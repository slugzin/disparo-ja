-- Função RPC corrigida baseada na estrutura real da tabela disparos_agendados
...
COMMENT ON FUNCTION finalizar_task IS 'Finaliza tarefa de disparo - muda status de processando para enviado, atualiza empresa para contato_realizado.';
