-- Função RPC simplificada para finalizar tarefa (sempre sucesso)
-- Atualiza status da empresa e registra como enviado
...
BEGIN
    ...
    -- Buscar informações do disparo processando para obter campanha_id
...
COMMENT ON FUNCTION finalizar_task IS 'Finaliza tarefa de disparo com sucesso - muda status de processando para enviado e atualiza empresa.';
